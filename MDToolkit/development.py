...
MoS2_monolayer_wpore, pore_area = create_pore_circular(MoS2_system)
print(pore_area)

# write_lammps_structure_file_atomic_full(h2o_system, file_name="H2O.data")

write_lammps_structure_file_atomic_full(MoS2_monolayer_wpore, file_name="MoS2_monolayer_pore.data")
